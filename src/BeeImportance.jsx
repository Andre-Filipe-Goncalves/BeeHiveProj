...
const BeeImportance = () => {
    return (  
    <div className="BeeImportance-general" >
        <h1>The importance of bees</h1>           
            <div className="BeeImportance" >
                    <div className="BeeText">
                        <p><h2>Why are they so important?</h2>A study found that just two percent of wild bee species contributes 80 percent of the crop pollination visits observed globally. This means that if this small percentage of bees disappears then 80 percent of our agricultural system will collapse.
